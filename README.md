# RayhanZuck/Baileks - Typescript/Javascript WhatsApp Web API
...
```
yarn add github:RayhanZuck/Baileks
```

Then import your code using:
``` ts 
import makeWASocket from 'RayhanZuck/Baileks'
```
...
``` ts
import makeWASocket, { DisconnectReason } from 'RayhanZuck/Baileks'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from 'RayhanZuck/Baileks'
...
``` ts
import makeWASocket, { makeInMemoryStore } from 'RayhanZuck/Baileks'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'RayhanZuck/Baileks'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from 'RayhanZuck/Baileks'
                                */
...
import { downloadMediaMessage } from 'RayhanZuck/Baileks'
